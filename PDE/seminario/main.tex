...
{%{ \Large QUALI SURVIVAL GUIDE COLLECTION} \\ 
 \large \textbf{Random Walks e Equação de Difussão}} \vspace{0.1in}   \\
 { \today }\\ 
 {\small
 \vspace{0.4cm} MM433 - EDP I  \hfill Nestor Heli Aponte Avila\(^{1}\) \\ 
  
Prof. Bianca Morelli \hfill \href{mailto:n267452@dac.unicamp.br}{\url{n267452@dac.unicamp.br}}} %\\
%Prof. Piper Pimienta \\
%\href{mailto:pipe@dac.unicamp.br}{\url{pipe@dac.unicamp.br}}}
\end{center} %Finaliza a centralização
\- \vspace{-1cm}

{\small ** O objetivo deste pequeno seminario é mostrar como à equação do calor surge num modelo discreto probabilistico e analisar essa relação. O conteúdo aquí exposto segue a linha de \cite[Cáp. 2]{SS} **\vspace{0.2cm}}%, destinado àqueles que já possuem alguma familiaridade com o assunto, pois não contém demonstrações formais, apenas as ideias por trás delas. Sinceramente, um fã da simplicidade. \\ 


%%%%%%%%%%%%%%%%%%%%%%%%% CONTENIDO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{ \large \textbf{Notação}} {\small \hfill \text{\rotatebox{45}{\large $\boxdot$}}  Definição \hfill {\large$\square$} \ Proposição \hfill  {\large $\blacksquare$}  \ Teorema  }
%{\scriptsize$\square$} \ Lema \hspace{2.4cm}  \hspace{2cm} {\scriptsize $\boxtimes$}  \ Corolário
...
\bibitem{SS}
Salsa, S. (2016). \textit{Partial differential equations in action}. Cham: Springer International Publishing.

\bibitem{evans}
Evans, L. (2010). \textit{Partial differential equations} (Vol. 19). American Mathematical Society.
\end{thebibliography}
}
%\end{multicols}
